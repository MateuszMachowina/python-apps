...
2. Mozilla Firefox - you must be logged into your Instagram account on it.
3. FFmpeg - required for rendering video and extracting thumbnails (you must download it, install it, and add it to your Windows PATH environment variables).
4. VLC media player - required for playing videos in the highlights viewer (viewer.py script).
...
1. Highlights Downloader (downloader.py)
...
3. Highlight Exporter (exporter.py)
...
4. Followers Tracker (tracker.py)
